...
class BlogTests(TestCase):
    ...
    #     self.assertTemplateUsed(response,'htmlPages/home.html')
    ...
    #     self.assertTemplateUsed(response,'htmlPages/post_details.html')
    ...
    def test_post_detail_view(self):
        ...
        self.assertEqual(no_response.status_code, 404)
        self.assertContains(response, 'A good title')
        self.assertTemplateUsed(response, 'htmlPages/post_detail.html')
